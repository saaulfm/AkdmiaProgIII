...
public class VentanaTablaV2 extends JFrame {
	...
	public VentanaTablaV2(JFrame vAnterior) {
		// Primera secuencia
		super();
		...
		lblInfo = new JLabel("Introduce el nombre a buscar: ");
		txtTextoABuscar = new JTextField(30);
		pNorte.add(lblInfo);
		pNorte.add(txtTextoABuscar);
		// Listener
		txtTextoABuscar.getDocument().addDocumentListener(new DocumentListener() {
			
			@Override
			public void removeUpdate(DocumentEvent e) {
				// Este método se ejecuta cada vez que el usuario borra algo del JTextField
				String texto = txtTextoABuscar.getText();
				...
				for(int i = 0; i<modeloCompleto.getRowCount(); i++) {
					...
					if(nombre.toUpperCase().contains(texto.toUpperCase())) {
			...
			public void insertUpdate(DocumentEvent e) {
				// Este método se ejecuta cada vez que el usuario escribe algo del JTextField
				String texto = txtTextoABuscar.getText();
			...
			public void changedUpdate(DocumentEvent e) {
				// Este método se ejecuta cada vez que el el texto que contiene ya el JTextField es modificado	
			}
		});
		// Última secuencia
		setVisible(true);
